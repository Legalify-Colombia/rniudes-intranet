...
    }: EmailNotificationRequest = await req.json();
    ...
    // --- LOGS DE DEPURACIÓN ---
    console.log('Datos recibidos:', { templateType, recipientEmails, variables, campusId });
...
    }
    ...
    console.log('Configuración de email con campusId:', emailConfig);
...
    }
    ...
    console.log('Plantilla de email encontrada:', template.subject);
...
    }
    ...
    console.log('Correo preparado para envío:', subject);
...
    }
    console.log('Correo enviado con éxito. ID de Resend:', emailResult.id);
